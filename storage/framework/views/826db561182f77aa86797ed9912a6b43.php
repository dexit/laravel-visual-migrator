...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/visual-migrator/assets/index.css')); ?>">
...
<body>
    ...
    <!-- The Core UI Script -->
    <script src="<?php echo e(asset('vendor/visual-migrator/assets/index.js')); ?>"></script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (window.MongoDiagram) {
                window.MongoDiagram.init({
                    ...
                    baseUrl: "<?php echo e(url(config('visual-migrator.path'))); ?>",
                    headers: {
...
<?php /**PATH /app/src/../resources/views/dashboard.blade.php ENDPATH**/ ?>